...
const Modal = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-5 rounded-lg w-11/12 sm:w-3/4 md:w-1/2 lg:hidden overflow-auto max-h-screen">
        <button
          onClick={onClose}
    ...
    <div className="py-28 px-5">
      <div className="flex justify-center">
        <h1 className="text-3xl font-serif md:text-5xl lg:text-6xl  ">
          The #1 job board for
          <br />
          <span className=" flex justify-center">graphic design jobs</span>
        </h1>
      </div>
      <div className="flex justify-center py-10">
        <p className="text-xl font-serif lg:text-2xl  lg:w-6/12">
      ...
      <div className=" flex justify-center">
        <button className=" bg-black text-white l  rounded-full px-6 lg:px-10 py-3 flex ">
          {" "}
          <IoMdAdd size={20} className=" mt-1" />
          posts
        </button>
      </div>
      <div className="flex items-center  justify-center py-5  ">
        <div className="flex   w-5/12 border-4 border-black/65 rounded-xl outline-pink-400">
          <IoMdSearch size={28} className="mr-2 mt-2" />
          <input
            type="text"
        ...
        <button
          ...
          className="bg-black text-white px-5 py-2 rounded-full ml-5 lg:hidden"
        >
          Filter
        </button>
      </div>
      ...
      <div className=" lg:px-56 ">
        <div>
          <p className="text-3xl font-serif">Recent posts</p>
          <p className="py-5 text-xl font-normal">
            3 new opportunities posted today!
          </p>
        </div>
        <div className="flex lg:space-x-52">
          <div>
            {companies.map((company, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="address-text text-sm">{company.address}</div>
                </div>
              </div>
            ))}
          </div>
